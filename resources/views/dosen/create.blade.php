        ...
        <form action="{{ route('dosen.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="nidn" id="nidn" value="{{ old('nidn') }}" class="w-full rounded-md border-gray-300 bg-gray-100 p-2 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50" required>
                    @error('nidn')
                ...
                <div>
                    ...
                    <input type="text" name="nama_dosen" id="nama_dosen" value="{{ old('nama_dosen') }}" class="w-full rounded-md border-gray-300 bg-gray-100 p-2 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50" required>
                </div>

                <div class="mb-4">
                    <label for="program_studi" class="block text-gray-700">Program Studi</label>
                    <select name="program_studi" id="program_studi" class="w-full px-3 py-2 border rounded-md shadow-sm bg-gray-100 focus:ring focus:ring-blue-200">
                ...
                <div>
                    ...
                    <input type="email" name="email" id="email" value="{{ old('email') }}" class="w-full rounded-md border-gray-300 bg-gray-100 p-2 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50" required>
                </div>
            </div>
