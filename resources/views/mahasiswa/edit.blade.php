    ...
    <div class="p-6 bg-white border-b border-gray-200">
        ...
        <form action="{{ route('mahasiswa.update', $mahasiswa['npm']) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    <label for="nidn" class="block text-sm font-medium text-gray-700 mb-1">NPM*</label>
                    <input type="text" name="npm" id="npm" value="{{ old('npm', $mahasiswa['npm']) }}" class="w-full rounded-md border-gray-300 bg-gray-100 p-2 shadow-sm" required>
                </div>

                <div>
                    <label for="nama_mahasiswa" class="block text-sm font-medium text-gray-700 mb-1">Nama Mahasiswa*</label>
                    <input type="text" name="nama_mahasiswa" id="nama_mahasiswa" value="{{ old('nama_mahasiswa', $mahasiswa['nama_mahasiswa']) }}" class="w-full rounded-md border-gray-300 bg-gray-100 p-2 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50" required>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="judul_skripsi" id="judul_skripsi" value="{{ old('judul_skripsi', $mahasiswa['judul_skripsi']) }}" class="w-full rounded-md border-gray-300 bg-gray-100 p-2 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50" required>
                </div>

                <div>
                    <label for="email" class="block text-sm font-medium text-gray-700 mb-1">Email*</label>
                    <input type="email" name="email" id="email" value="{{ old('email', $mahasiswa['email']) }}" class="w-full rounded-md border-gray-300 bg-gray-100 shadow-sm p-2 focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50" required>
                </div>
            </div>
