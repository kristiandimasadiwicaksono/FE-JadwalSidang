                    ...
                    <div class="flex-1 flex flex-col overflow-y-auto">
                        <nav class="flex-1 px-2 py-4 space-y-1">
                            ...
                            <a href="{{ route('dosen.index') }}" 
                                class="group flex items-center px-2 py-2 text-sm font-medium rounded-md {{ request()->routeIs('dosen.*') ? 'bg-blue-600 text-white' : 'text-gray-600 hover:bg-gray-100' }}">
                                <i class="fas fa-user mr-3 {{ request()->routeIs('dosen.*') ? 'text-white' : 'text-gray-400 group-hover:text-gray-500' }}"></i>
                                Dosen
                            </a>
